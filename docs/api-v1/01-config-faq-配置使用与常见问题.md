...
- **手册编号**: `2.1`
- **页面 ID**: `1397`
- **官方文档**: https://www.zentao.net/book/api/1397.html
...
（1）保证账号有查看1号产品的bug访问权限（权限调整可以在后台-人员管理-权限中进行调整，具体可以参考文档 https://www.zentao.net/book/zentaopms/1010.html）（2）请求 zentaourl/api.php/v1/tokens 接口获取 token，以 curl 命令举例如下，Header 中设定 Content-Type 为 application/json ，data 中设定用户对应的 account 和 password
